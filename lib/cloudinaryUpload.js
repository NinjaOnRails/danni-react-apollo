...
const uploadCusThumbnail = (
  ...
  // Prepare params to send
  const publicId = `thumbnail-${id}-${youtubeId}-${language}`;
  const tags = `${id},${youtubeId},${language},${timestamp},custom-thumbnail,custom,thumbnail,audio-thumbnail,picture,image`;
