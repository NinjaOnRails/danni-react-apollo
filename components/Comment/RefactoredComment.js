...
const VideoComment = ({
  ...
  const [updateCommentFormValid, setUpdateCommentFormValid] = useState(true);
  ...
  const onCommentUpdate = async updateComment => {
  ...
  const onConfirmDelete = deleteComment => {
    deleteComment();
  };

  const onVoteClick = (type, comment, createCommentVote) => {
