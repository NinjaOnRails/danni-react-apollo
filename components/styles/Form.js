...
const Form = styled.form`
  ...
  width: ${props => (props.isModal ? '80%' : 'auto')};
  margin: 0 auto;
  box-shadow: ${props =>
  ...
  fieldset {
    ...
    &::before {
      ...
      margin: ${props => (props.isModal ? '0.5rem auto' : '0')};
    ...
    .ui.facebook.button {
      display: block;
       /* ${props => (props.isModal ? 'inline-block' : 'block')}; */
      margin: ${props => (props.isModal ? '0.75rem auto' : '0 0 1rem 0')};
    }
  }
`;
