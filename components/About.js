  ...
  <AboutStyle>
    <Container text>
      ...
      <p>
        ...
        developing our own recording tool, meanwhile watch this video on how to
        record and upload.
      </p>

      <p>
        BECOME A TRANSLATOR Register and start translating. Use YouTube or some
        other tool to translate, and then share the text here for others to dub.
        We are currently developing our own translation tool, meanwhile watch
        this video on how to translate videos.
      </p>
      <p>
        SUPPORT THE PROJECT Subscribe and share the content you like. Give us
        feedback, write about us Mention us in your videos, blogs or posts. Join
        the team!
      </p>
